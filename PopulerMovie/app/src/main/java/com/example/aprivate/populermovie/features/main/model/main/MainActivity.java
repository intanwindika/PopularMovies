...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int STATE_UPCOMING_MOVIE = 2;
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuId == R.id.action_popular) {
                    ...
                    currentState = STATE_UPCOMING_MOVIE;
                    fetchUpcomingMovie();
                }
    ...
    private void fetchUpcomingMovie() {
        ...
        hideMovieList();
        hideMessage();
        Call<MovieDataResponse> call = TmdbService.open().getUpcomingMovies(1);
        call.enqueue(new Callback<MovieDataResponse>() {
            @Override
            public void onResponse(Call<MovieDataResponse> call, Response<MovieDataResponse> response) {
                MovieDataResponse data = response.body();
                ...
                if (data != null) {
                    ...
                    if (movies != null && !movies.isEmpty()) {
                        showMovieList(
                                MovieDataToMainItemConverter.getMainItemList("Upcoming Movies", movies)
